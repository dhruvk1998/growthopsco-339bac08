...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative px-6 pt-28 pb-10">
      <div className="mx-auto max-w-6xl text-center">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-accent/25 bg-accent/5 px-3 py-1 text-[11px] font-bold uppercase tracking-widest text-accent">
        ...
        <h1 className="mb-4 text-5xl font-bold leading-[1.02] tracking-tight md:text-6xl lg:text-7xl">
          Stop losing leads. <span className="text-accent">Run a sales process you can actually see.</span>
        </h1>
        <p className="mx-auto mb-6 max-w-2xl text-base leading-relaxed text-muted-foreground lg:text-lg">
